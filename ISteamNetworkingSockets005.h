...
#ifndef ISTEAMNETWORKINGSOCKETS005_H
#define ISTEAMNETWORKINGSOCKETS005_H
#ifdef _WIN32
#pragma once	
#endif

#include "SteamTypes.h"
#include "SteamNetworkingSocketsCommon.h"
...
abstract_class ISteamNetworkingSockets005
{
public:
	...
	//Unknown
	virtual unknown_ret ConnectP2PCustomSignaling(ISteamNetworkingConnectionCustomSignaling *a1, const SteamNetworkingIdentity *a2, int nOptions, const SteamNetworkingConfigValue_t *pOptions) = 0;
	virtual unknown_ret ReceivedP2PCustomSignal(const void *a1, int a2, ISteamNetworkingCustomSignalingRecvContext *a3) = 0;
};


#endif // ISTEAMNETWORKINGSOCKETS005_H