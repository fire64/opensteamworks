...
#ifndef ISTEAMPARTIES001_H
#define ISTEAMPARTIES001_H
#ifdef _WIN32
#pragma once	
#endif
...
//-----------------------------------------------------------------------------
abstract_class ISteamParties001
{
public:
	...
	virtual bool GetBeaconDetails( PartyBeaconID_t ulBeaconID, CSteamID *pSteamIDBeaconOwner, STEAM_OUT_STRUCT() SteamPartyBeaconLocation_v001_t *pLocation, STEAM_OUT_STRING_COUNT(cchMetadata) char *pchMetadata, int cchMetadata ) = 0;
	...
	virtual bool GetAvailableBeaconLocations( SteamPartyBeaconLocation_v001_t *pLocationList, uint32 uMaxNumLocations ) = 0;
	...
	virtual SteamAPICall_t CreateBeacon( uint32 unOpenSlots, SteamPartyBeaconLocation_v001_t *pBeaconLocation, const char *pchConnectString, const char *pchMetadata ) = 0;
	...
	// Utils
	virtual bool GetBeaconLocationData( SteamPartyBeaconLocation_v001_t BeaconLocation, ESteamPartyBeaconLocationData eData, STEAM_OUT_STRING_COUNT(cchDataStringOut) char *pchDataStringOut, int cchDataStringOut ) = 0;

};


#endif // ISTEAMPARTIES001_H
